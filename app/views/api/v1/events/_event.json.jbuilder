...
json.start_time formatted_api_datetime(event.start_time.in_time_zone(event.address&.time_zone))
json.start_time_utc formatted_api_datetime(event.start_time)

json.end_time formatted_api_datetime(event.end_time.in_time_zone(event.address&.time_zone))
