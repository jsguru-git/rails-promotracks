# User.create(email: 'dev@bitcot.com', password: 'bitcotadmin', password_confirmation: 'bitcotadmin', first_name: 'Dev', last_name: 'Bitcot', role: :super_admin)
# User.create(email: 'admin@promotracks.com', password: 'iampromo', password_confirmation: 'iampromo', first_name: 'Promo', last_name: 'user', role: :super_admin)
#
...
10.times do |i|
  ...
  6.times do |j|
    promo_rep=client.users.new(:first_name => Faker::Name.first_name, :last_name => Faker::Name.last_name, :email => Faker::Internet.safe_email, password: password, password_confirmation: password, :token => (10000..99999).to_a.sample, :role => 'promo_rep')
    if promo_rep.valid?
      promo_rep.save
    else
